module.exports = function () {
  ...
  try {
    files.forEach(file => {
      ...
      $.ssg.savePostDataForIndexPage(fileData, dateFormatted, postData, postId, postsDataForIndexPage) // read layout data from file and then render layout with post contents
