  ...
  try {
    pages.forEach(file => {
      ...
      switch (name) {
        ...
        case "contact.ejs":
          layoutContent = ejsRender($.fse.readFileSync(`${srcPath}/layouts/default-breadcrumb-left.ejs`, "utf-8"), Object.assign({}, config, {
        ...
        case "open-hours.ejs":
          layoutContent = ejsRender($.fse.readFileSync(`${srcPath}/layouts/open-hours.ejs`, "utf-8"), Object.assign({}, config, {
